...
namespace MFR.Objects.CommandLine.Validators
{
    ...
    public class RootDirectoryValidator : IRootDirectoryValidator
    {
        ...
        /// <see cref="T:MFR.Objects.CommandLine.Validators.RootDirectoryValidator" />.
        /// </summary>
        [Log(AttributeExclude = true)]
        ...
        /// <see
        ///     cref="P:MFR.Objects.CommandLine.CommandLineInfo.RootDirectory" />
        /// property is invalid.
        /// </summary>
        ...
        /// Raises the
        /// <see
        ///     cref="E:MFR.Objects.CommandLine.Validators.RootDirectoryValidator.RootDirectoryInvalid" />
        /// event.
        /// </summary>
        /// <param name="e">
        /// A
