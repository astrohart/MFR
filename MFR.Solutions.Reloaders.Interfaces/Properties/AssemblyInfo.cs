...
[assembly: AssemblyTitle("xyLOGIX Interfaces Support Library for Project File Renamer's Solution Reloaders Component")]
[assembly: AssemblyDescription("Provides objects and functionality to track the open Visual Studio Solution (*.sln) files loaded in various instances of Visual Studio, and to close and open them in the Visual Studio instances that have them open.  The thinking is that the file renaming and find/replace operations that are requested cannot take place unless the corresopnding Visual Studio Solution is not open in an instance of Visual Studio. However, this being said, we want to keep track of which solutions were open in what instance of Visual Studio, in case the user specifies that all Solutions closed by the application are to be reopened upon completion of the processing.  This particular library holds the C# interfaces for this component.")]
...
[assembly: Guid("f8afa37e-5aa6-4f60-82f9-d366c52e8c91")]
