...
namespace MFR.Operations.Descriptions
{
    ...
    /// </summary>
    public class
        CleanFilesOperationStartedDescription :
        IOperationStartedDescription
    {
        ...
        static CleanFilesOperationStartedDescription() { }

        /// <summary>
        /// Empty, protected constructor to prohibit direct allocation of this class.
        /// </summary>
        [Log(AttributeExclude = true)]
        protected CleanFilesOperationStartedDescription() { }
        ...
        {
            get;
        } = new CleanFilesOperationStartedDescription();
        ...
        {
            get;
        } = Resources.OperationStartedDescription_CleanFiles;
    }
}