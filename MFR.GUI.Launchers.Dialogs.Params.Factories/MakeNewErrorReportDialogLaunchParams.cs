...
namespace MFR.GUI.Launchers.Dialogs.Params.Factories
{
    ...
    public static class MakeNewErrorReportDialogLaunchParams
    {
        ...
        /// </param>
        /// <param name="owner">
        /// (Optional; can be null.) Reference to an instance of an object that implements the <see cref="T:System.Windows.Forms.IWin32Window" /> interface.<para/>This object represents the parent window of the dialog.
        /// <para />
        /// Callers of this dialog can implement their custom behavior for sending detailed
        /// error reports via this handler.
        /// </param>
