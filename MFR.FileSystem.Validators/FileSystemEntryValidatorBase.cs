...
namespace MFR.FileSystem.Validators
{
        ...
        FileSystemEntryValidatorBase : IFileSystemEntryValidator
    {
        ...
        public virtual bool DoesExist(IFileSystemEntry entry)
        {
            ...
            DebugUtils.WriteLine(DebugLevel.Debug, "In FileSystemEntryValidatorBase.DoesExist");
            ...
            if (entry == null)
            {
                ...
                // log the result
                DebugUtils.WriteLine(
                    DebugLevel.Debug, $"FileSystemEntryValidatorBase.DoesExist: Result = {result}"
                );

                DebugUtils.WriteLine(DebugLevel.Debug, "FileSystemEntryValidatorBase.DoesExist: Done.");
            ...
            DebugUtils.WriteLine(DebugLevel.Debug, $"FileSystemEntryValidatorBase.DoesExist: entry.Path = '{entry.Path}'");
        ...
        public virtual bool ShouldSkip(string path)
        {
            ...
            try
            {
                result = string.IsNullOrWhiteSpace(path) ||
                         !DoesExist(path) || path.Contains("packages") ||
