...
[assembly: AssemblyTitle("MFR.CommandLine.Handlers.Constants")]
[assembly: AssemblyDescription("Provides objects and functionality to handle the various use-cases when invalid input is sent over the command line; either a root directory is blank or missing, does not contain .sln file(s) in its directory tree, or there are multiple instance(s) of Visual Studio open but none of them have the Solution(s) found in the target directory tree, loaded.  We want to develop various user-assistance strategy(ies) to help the user with these use-cases.  This particular library holds the named constants and enumerations for this component.")]
...
[assembly: Guid("e612c545-111f-4ddf-8f4c-5bd9f19971cd")]
