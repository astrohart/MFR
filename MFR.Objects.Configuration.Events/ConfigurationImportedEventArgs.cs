...
namespace MFR.Objects.Configuration.Events
{
    /// <summary>
    /// Defines the data that is passed by all events of type <see cref="T:MFR.Objects.Configuration.Events.ConfigurationImportedEventHandler"/>.
    /// </summary>
    public class ConfigurationImportedEventArgs : EventArgs
    {
        /// <summary>
        /// Creates a new instance of <see
        /// cref="T:MFR.Objects.Configuration.Events.ConfigurationImportedEventArgs"/>
