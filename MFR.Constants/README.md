...
- [FileRenamerMessages](#T-MFR-Constants-FileRenamerMessages 'MFR.Constants.FileRenamerMessages')
  ...
  - [FRM_PENDING_CHANGES_TO_BE_COMMITTED_COUNTED](#F-MFR-Constants-FileRenamerMessages-FRM_PENDING_CHANGES_TO_BE_COMMITTED_COUNTED 'MFR.Constants.FileRenamerMessages.FRM_PENDING_CHANGES_TO_BE_COMMITTED_COUNTED')
  ...
  - [FRM_RESULTS_TO_BE_COMMITTED_TO_GIT_COUNTED](#F-MFR-Constants-FileRenamerMessages-FRM_RESULTS_TO_BE_COMMITTED_TO_GIT_COUNTED 'MFR.Constants.FileRenamerMessages.FRM_RESULTS_TO_BE_COMMITTED_TO_GIT_COUNTED')
...
<a name='F-MFR-Constants-FileRenamerMessages-FRM_PENDING_CHANGES_TO_BE_COMMITTED_COUNTED'></a>
### FRM_PENDING_CHANGES_TO_BE_COMMITTED_COUNTED `constants`
...
<a name='F-MFR-Constants-FileRenamerMessages-FRM_RESULTS_TO_BE_COMMITTED_TO_GIT_COUNTED'></a>
### FRM_RESULTS_TO_BE_COMMITTED_TO_GIT_COUNTED `constants`
