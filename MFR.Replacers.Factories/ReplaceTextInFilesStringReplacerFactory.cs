            ...
            switch (matchingConfig)
            {
                ...
                default:
                    throw new ArgumentOutOfRangeException(
                        ...
                        $"There are no string replacer objects defined for the Replace Text in Files operation type that support the '{matchingConfig}' matching projectFileRenamerConfiguration."
                    );
            }
