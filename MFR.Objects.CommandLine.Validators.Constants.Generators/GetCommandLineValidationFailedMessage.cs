...
namespace MFR.Objects.CommandLine.Validators.Constants.Generators
{
    /// <summary>
    ...
    public class GetCommandLineValidationFailedMessage
    {
        ...
        /// <see
        ///     cref="T:MFR.Objects.CommandLine.Validators.Constants.Generators.GetCommandLineValidationFailedMessage" />
        /// .
        /// </summary>
        [Log(AttributeExclude = true)]
