...
namespace MassFileRenamer.Objects
{
    ...
    /// langword="true"/> and Match Exact Word is set to <see langword="true"/>,
            ...
            RenameFilesInFolderStringMatcherBase
    {
        ...
        /// <summary>
        /// Gets a reference to the one and only instance of <see cref="T:MassFileRenamer.Objects.MatchCaseAndExactWordFileNameStringMatcher"/>.
        /// </summary>
        [Log(AttributeExclude = true)]
