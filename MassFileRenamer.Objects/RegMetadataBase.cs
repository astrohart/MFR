...
namespace MassFileRenamer.Objects
{
    ...
    /// interface and the
    /// <see cref="T:MassFileRenamer.Objects.IRegOperationMetadata" /> interface.
    /// </summary>
    public class RegMetadataBase
    {
        ...
        /// <see cref="P:MassFileRenamer.Objects.IRegOperationMetadata.Hive" />
        ...
        /// <see
        ///     cref="P:MassFileRenamer.Objects.RegQueryExpression.Hive" />
        /// property
        /// to the result.
        /// </summary>
        /// <param name="keyPath">
