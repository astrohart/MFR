...
namespace MassFileRenamer.Objects
{
    ...
    public static class ConvertConfiguration
    {
        /// <summary>
        /// Reference to a <see
        /// cref="T:Newtonsoft.Json.JsonSerializerSettings"/> that specifies how
        ...
        /// an object that implements the <see
        /// cref="T:MassFileRenamer.GUI.IConfiguration"/> interface and returns
        /// a reference to it.
        /// </summary>
        /// <param name="json">
        ...
        /// cref="T:MassFileRenamer.GUI.IConfiguration"/> object whose
        /// properties are initialized to the data values read in from the JSON text.
        /// </returns>
        public static IConfiguration FromJson(string json)
           => JsonConvert.DeserializeObject<Configuration>(json, Settings);

        /// <summary>
        /// Converts an instance of an object that implements the <see
        /// cref="T:MassFileRenamer.GUI.IConfiguration"/> interface into a
        /// JSON-formatted string and returns the resultant string.
        /// </summary>
        /// <param name="configuration">
        /// (Required.) Reference to an instance of an object that implements
        /// the <see cref="T:MassFileRenamer.GUI.IConfiguration"/> interface.
        /// </param>
        /// <returns>
        /// String containing the JSON equivalent of the <paramref
        /// name="configuration"/> object fed in.
        /// </returns>
