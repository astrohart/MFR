...
namespace MassFileRenamer.Objects
{
    ...
    public class PathFilterInvokerBase : IPathFilterInvoker
    {
        ...
        /// <summary>
        /// Gets a reference to the one and only instance of <see cref="T:MassFileRenamer.Objects.PathFilterInvokerBase"/>.
        /// </summary>
        ...
        /// cref="M:MassFileRenamer.Objects.IPathFilterInvoker.AndPath"/> method.
        /// </summary>
        ...
        /// </returns>
        public bool Pass(Predicate<string> pathFilter)
