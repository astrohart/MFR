...
namespace MFR.Configuration.Converters
{
    /// <summary>
    /// Converts JSON-formatted text to and from instances of C# objects that
    /// implement the <see cref="T:MFR.Configuration.Interfaces.IProfileCollection" />
    /// interface.
    /// </summary>
    public static class ConvertProfileList
    {
        ...
        /// <see
        ///     cref="T:MFR.Configuration.Interfaces.IProfileCollection" />
        /// interface and
        ...
        /// the <see cref="T:MFR.Configuration.Interfaces.IProfileCollection" /> interface
