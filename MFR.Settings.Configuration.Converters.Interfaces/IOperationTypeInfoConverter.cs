...
{
    /// <summary>
    /// Defines the publicly-exposed methods and properties of an object that converts instances of objects implementing the <see cref="T:MFR.GUI.Models.Interfaces.IOperationTypeInfo" /> interface to and from JSON.
    /// </summary>
    public interface IOperationTypeInfoConverter
    {
        /// <summary>
        ...
        object ReadJson(JsonReader reader, Type objectType,
        ...
        /// <param name="serializer">The calling serializer.</param>
        void WriteJson(JsonWriter writer, object value,
