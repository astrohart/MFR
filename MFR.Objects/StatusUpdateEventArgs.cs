...
{
    /// <summary>
    /// Defines the data that is passed by all events of type <see cref="T:MFR.Objects.StatusUpdateEventHandler"/>.
    /// </summary>
    public class StatusUpdateEventArgs : EventArgs
    {
        /// <summary>
        /// Constructs a new instance of <see
        /// cref="T:MFR.Objects.StatusUpdateEventArgs"/> and returns
        /// a reference to it.
        /// </summary>
        /// <param name="text">
