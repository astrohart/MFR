namespace MFR.Objects
{
        ...
        TextExpressionMatchRequestedEventArgs : TextPatternMatchEventArgs
    {
        ...
        /// <paramref name="source" /> parameter on the disk (unless we are performing the <see cref="T:MFR.Objects.OperationType.ReplaceTextInFiles"/> operation).
        /// </exception>
        public TextExpressionMatchRequestedEventArgs(string source,
            string findWhat, string replaceWith, OperationType operationType) : base(
        ...
        /// </param>
        public TextExpressionMatchRequestedEventArgs(OperationType operationType) : base(
            operationType
        ) { }
