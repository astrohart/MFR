...
namespace MFR.GUI.Application
{
    ...
    public class ProjectFileRenamerApp : IWinApp
    {
        ...
        /// interface.
        /// </summary>
        private ICommandLineValidator CommandLineValidator
        ...
        /// associated with it.
        /// </remarks>
        private IProjectFileRenamerConfigurationProvider ConfigurationProvider
        ...
        public void WinInit(string[] args)
        {
            ...
            if (IsAutoStarted(args))
                using (var dialog = MakeNewOperationDrivenProgressDialog
                                    .FromScratch()
                                    .HavingProc(arg => InitApplication(arg))
                                    .AndArgument(args)
                                    .AndStatusText(
        ...
        /// </remarks>
        private bool IsAutoStarted(IEnumerable<string> args)
        ...
        /// </remarks>
        private void OnCommandLineInfoInvalid(object sender,
        ...
        private void OnCommandLineParserDisplayHelp(object sender,
        ...
        /// </remarks>
        private void ShowValidationFailureMessage(string message)
        {
