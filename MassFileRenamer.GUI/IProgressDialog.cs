...
namespace MassFileRenamer.GUI
{
   ...
   public interface IProgressDialog : IForm
   {
      ...
      /// </summary>
      string DetailedStatus { [DebuggerStepThrough] get; set; }

      /// <summary>
      /// Gets or sets the maximum value of the range of the progress bar control.
      /// </summary>
      int ProgressBarMaximum { [DebuggerStepThrough] get; set; }

      /// <summary>
      /// Get or sets the minimum value of the range of the progress bar control.
      /// </summary>
      int ProgressBarMinimum { [DebuggerStepThrough] get; set; }

      /// <summary>
      /// Gets or sets the manner in which progress should
      /// </summary>
      ProgressBarStyle ProgressBarStyle { [DebuggerStepThrough] get; set; }

      /// <summary>
      /// Gets or sets the current position of the progress bar.
      /// </summary>
      int ProgressBarValue { [DebuggerStepThrough] get; set; }

      /// <summary>
      /// Gets or sets a string containing the new status.
      /// </summary>
      string Status { [DebuggerStepThrough] get; set; }
