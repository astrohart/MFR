...
{
    /// <summary>
    /// Provides information for <c>FileStreamOpenFailed</c> event handlers.
    /// </summary>
    public class FileStreamOpenFailedEventArgs : EventArgs
    {
        /// <summary>
        ...
        /// failure reason.
        /// </param>
        public FileStreamOpenFailedEventArgs(
            string pathname,
            Exception exception
        )
        {
